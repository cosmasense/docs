...
<Card title="How Search Works" icon="brain" href="/api-reference/endpoint/get">
...
<Card title="Watch Directories" icon="folder-open" href="/api-reference/endpoint/create">
