...
<AccordionGroup>
  <Accordion icon="github" title="Clone from GitHub">
    ...
    ```bash
    git clone https://github.com/your-org/cosmasense.git
    cd cosmasense
    ```
...
```bash API Search
# Direct API search
curl http://localhost:60534/api/search/stream \
  -H "Content-Type: application/json" \
...
<Note>
  **Need help?** Check out our [GitHub issues](https://github.com/your-org/cosmasense/issues) or read the [development guide](/development).
</Note>
